package blue.sparse.bshade.versions.v1_12_R1;
...
public class VersionedEntityImpl extends VersionedEntity {
    ...
    private net.minecraft.server.v1_12_R1.Entity getNmsEntity() {
    ...
    public List<ItemStack> getDrops(int looting, boolean forceLooting) {
        ...
        net.minecraft.server.v1_12_R1.Entity nmsEntity = getNmsEntity();
