...
public class VersionedPlayerImpl extends VersionedPlayer {
    ...
    public void sendTitle(String title, String subTitle, int fadeIn, int stay, int fadeOut) {
        ...
        connection.sendPacket(new PacketPlayOutTitle(EnumTitleAction.TITLE, chatTitle));
        connection.sendPacket(new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, chatSubTitle));
